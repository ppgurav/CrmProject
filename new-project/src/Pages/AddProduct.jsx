...
export default function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.hsnSacCode) newErrors.hsnSacCode = "HSN/SAC code is required"
    ...
    const apiData = {
      ...
      gst_rate: Number.parseInt(formData.gstRate),
      hsn_sac: formData.hsnSacCode,
      status: formData.activeStatus.toLowerCase(),
    }
