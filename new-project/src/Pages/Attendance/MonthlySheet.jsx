...
export default function MonthlySheet() {
  ...
  return (
    ...
    <div className="max-w-full">
        ...
        {/* Filters Section */}
        <div className="bg-white rounded-2xl shadow-lg shadow-indigo-500/5 p-6 border border-gray-100 mb-3 ml-6 mr-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg shadow-indigo-500/5 border border-gray-100 ml-6 mr-6">
